...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	// 初始化vs 和ps
	result = InitializeShader(device, hwnd, TEXT("color.vs"), TEXT("color.ps"));
	if(!result)
		return false;
...
void ColorShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, TCHAR* shaderFilename)
{
	char* compileErrors;
